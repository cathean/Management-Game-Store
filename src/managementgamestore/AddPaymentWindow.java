...
public class AddPaymentWindow extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error!, Please only use numbers in 'No'!", "Message",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPaymentWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
